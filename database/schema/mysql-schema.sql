...
CREATE TABLE `arrivages` (
  ...
  `fournisseur_id_old` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `numero_bon_livraison` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `details_produits` json NOT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `decharge_signee_path` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `clients` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nom` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('Grossiste','Hôtel/Restaurant','Particulier','Defaut') COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'approved',
  `telephone` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remember_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `identifiant_unique_somacif` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `entrepots_de_livraison` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `fournisseurs` (
  ...
  `telephone_contact` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `inventories` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `point_de_vente_id` bigint unsigned NOT NULL,
  `unite_de_vente_id` bigint unsigned NOT NULL,
  `quantite_stock` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `inventories_point_de_vente_id_foreign` (`point_de_vente_id`),
  KEY `inventories_unite_de_vente_id_foreign` (`unite_de_vente_id`),
  CONSTRAINT `inventories_point_de_vente_id_foreign` FOREIGN KEY (`point_de_vente_id`) REFERENCES `point_de_ventes` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `notification_templates` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Nom lisible pour l''admin',
  `key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Clé programmatique',
  `channel` enum('mail','sms') COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `subject` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Sujet pour les emails',
  `body` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Contenu du message avec variables',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT 'Description pour l''admin',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `orders` (
  ...
  `statut` enum('en_attente','validee','en_preparation','en_cours_livraison','livree','annulee') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en_attente',
  `statut_paiement` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Non réglé',
...
CREATE TABLE `payments` (
  ...
  `method` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Manuel',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `point_de_ventes` (
  ...
  `nom` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('Principal','Secondaire','Partenaire') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `products` (
  ...
  `description_longue` longtext COLLATE utf8mb4_unicode_ci,
  `infos_nutritionnelles` longtext COLLATE utf8mb4_unicode_ci,
  `idee_recette` longtext COLLATE utf8mb4_unicode_ci,
  `calibres` json DEFAULT NULL,
  `origine` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `poids_moyen` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `conservation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `reglements` (
  ...
  `methode_paiement` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Espèces',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `user_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,

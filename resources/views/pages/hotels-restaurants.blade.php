<x-layouts.app>
    ...
    <main class="page-hotels-restaurants">
        ...
        <section class="py-24">
            <div class="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="h-[500px] rounded-lg overflow-hidden">
                    <img src="{{ !empty($page->images['presentation_image']) ? Storage::url($page->images['presentation_image']) : 'https://placehold.co/600x800/1E40AF/FFFFFF?text=Plat+gastronomique' }}"
                         alt="Image de présentation H&R" class="w-full h-full object-cover">
                </div>
            </div>
        </section>

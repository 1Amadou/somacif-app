<x-layouts.app>
    ...
    <main class="page-grossistes">
        <section class="page-header-bg py-24 md:py-32 bg-cover bg-center"
                 style="background-image: linear-gradient(to top, rgba(10, 10, 10, 1) 5%, rgba(10, 10, 10, 0.7) 100%), url('{{ !empty($page->images['header_background']) ? Storage::url($page->images['header_background']) : 'https://placehold.co/1920x600/111827/FFFFFF?text=Grossiste' }}')">
        ...
        <section class="py-24">
            <div class="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
                <div class="h-[500px] rounded-lg overflow-hidden">
                    <img src="{{ !empty($page->images['presentation_image']) ? Storage::url($page->images['presentation_image']) : 'https://placehold.co/600x800/1E40AF/FFFFFF?text=Logistique' }}"
                         alt="Image de présentation grossiste" class="w-full h-full object-cover">
                </div>
                <div>

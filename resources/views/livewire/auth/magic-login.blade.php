    ...
    @if (!$codeSent)
        ...
        <form wire:submit.prevent="sendCode">
            ...
            <div class="mt-6">
                ...
                <input type="text" wire:model="identifier" id="identifier" class="form-input w-full">
    ...
    @else
        ...
        <form wire:submit.prevent="verifyCode">
            ...
            <div class="mt-6">
                ...
                <input type="text" wire:model="code" id="code" class="form-input w-full text-center tracking-widest">
